...
{   
    ...
    class CardTest
    {
        ...
        {
            Card test = new Card(0,1,0,0,0,0,0,"Copper","Single valued Currency card");
            Assert.NotNull(test);
        }
        ...
        {
            Card test = new Card(0, 0, 0, 0, 0, 0, 0,"Null Card","Null Card");
            Assert.AreEqual(0, test.getType());
            test = new Card(1, 0, 0, 0, 0, 0, 0,"Null Card","Null Card");
            Assert.AreEqual(1, test.getType());
            test = new Card(99, 0, 0, 0, 0, 0, 0,"Null Card","Null Card");
        ...
        public void testGetCash()
        {
            ...
            test = new Card(0, 1, 0, 0, 0, 0, 0, "Null Card", "Null Card");
            Assert.AreEqual(1, test.getCash());
            test = new Card(99, 99, 0, 0, 0, 0, 0, "Null Card", "Null Card");
            Assert.AreEqual(99, test.getType());
        }
        ...
        public void testGetBuy()
        {
            ...
            test = new Card(1, 0, 1, 0, 0, 0, 0, "Null Card", "Null Card");
            Assert.AreEqual(1, test.getBuy());
            test = new Card(5, 0, 99, 0, 0, 0, 0, "Null Card", "Null Card");
        ...
        public void testGetActions()
        {
            ...
            test = new Card(1, 0, 0, 1, 0, 0, 0, "Null Card", "Null Card");
            Assert.AreEqual(1, test.getActions());
            test = new Card(3, 0, 0, 99, 0, 0, 0, "Null Card", "Null Card");
        ...
        public void testGetVictoryPoints()
        {
            ...
            test = new Card(0, 0, 0, 0, 1, 0, 0, "Null Card", "Null Card");
            Assert.AreEqual(1, test.getVictoryPoints());
            test = new Card(3, 0, 0, 0, 99, 0, 0, "Null Card", "Null Card");
        ...
        public void testGetDraws()
        {
            ...
            test = new Card(0, 0, 0, 0, 0, 1, 0, "Null Card", "Null Card");
            Assert.AreEqual(1, test.getAdditionalDraws());
            test = new Card(3, 0, 0, 0, 4, 99, 0, "Null Card", "Null Card");
        ...
        public void testFunctionNumber()
        {
            ...
            test = new Card(0, 0, 0, 0, 1, 0, 1, "Null Card", "Null Card");
            Assert.AreEqual(1, test.getFunctionNumber());
            test = new Card(3, 0, 2, 0, 99, 4, 99, "Null Card", "Null Card");
        ...
        {
            Card test = new Card(0, 0, 0, 0, 0, 0, 0, "Card Name", "Null Card");
        ...
        {
            Card test = new Card(0, 0, 0, 0, 0, 0, 0, "Card Name", "This is the card description");
